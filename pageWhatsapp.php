    ...
    <div class="col-lg-12">
        <div class="card chat-app">
            <div id="plist" class="people-list">
                ...
                <ul class="list-unstyled chat-list mt-2 mb-0" id="lista-conversas">
                    <?php            
                        // Buscar conversas
                    ...
                    <li class="clearfix">
                        ...
                        <div class="about">
                            <div class="name"><?=$conversa['remetente'];?></div>
...
function atualizarConversas() {
    $.ajax({
        url: 'buscarConversas.php',
        method: 'GET',
        dataType: 'json',
        success: function (response) {
            if (response.success) {
                // Limpa a lista atual
                $('#lista-conversas').empty();

                // Adiciona cada conversa à lista
                response.data.forEach(function (conversa) {
...
setInterval(atualizarConversas, 5000);
